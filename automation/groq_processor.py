...
class GroqProcessor:
    ...
    def generate_url(self, text: str) -> Optional[str]:
        ...
        prompt = (
            ...
            "2. Easy to remember\n"
            "3. Similar to popular domains like 'chat.com', 'google.com', 'help.com', 'ai.com', 'we.com', or 'go.com' DO NOT INCLUDE '.com' IN YOUR RESPONSE\n"
            "4. DO NOT INCLUDE '.com' IN YOUR RESPONSE"
